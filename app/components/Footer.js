...
export default function Footer() {
    return (
        <footer className="bg-gray-800 text-white mt-36">
            <div className="max-w-7xl mx-auto pt-12 px-4 sm:px-6 lg:pt-16 lg:px-8">
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul className="mt-4 space-y-4">
                                    <li><Link href="#" className="text-base text-gray-300 hover:text-white">Visitor Check-in</Link></li>
                                    <li><Link href="#" className="text-base text-gray-300 hover:text-white">Host Notifications</Link></li>
                                    <li><Link href="#" className="text-base text-gray-300 hover:text-white">Reporting & Analytics</Link></li>
                                    <li><Link href="#" className="text-base text-gray-300 hover:text-white">Security</Link></li>
                                </ul>
                            </div>
                ...
                <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
                    ...
                    <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
                        Copyright 2024&copy; A V Techno Soft India Private Limited . All Rights Reserved.
                    </p>
                </div>
            </div>
        </footer>
